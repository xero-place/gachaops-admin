...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'flex flex-wrap sm:inline-flex sm:flex-nowrap h-auto min-h-9 items-center justify-start sm:justify-center gap-1 rounded-md bg-muted p-1 text-muted-foreground max-w-full',
      className,
    )}
    {...props}
  />
